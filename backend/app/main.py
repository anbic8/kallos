...
from .routers import auth, kaempfer, vereine, stammdaten, veranstaltungen, kaempfe, medien, erfolge, mannschaft, ikkz, leistungstests, rangliste, gruppen, anwesenheit
